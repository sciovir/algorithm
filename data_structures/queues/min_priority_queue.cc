...
int main() {
  ...
  data_structures::queues::MinPriorityQueue<int> int_min_priority_queue(integers);
  data_structures::queues::MinPriorityQueue<std::string> str_min_priority_queue(strings);
  ...
  std::cout << "Extract Min: " << int_min_priority_queue.ExtractMin() << std::endl;
  std::cout << "Size: " << int_min_priority_queue.GetSize() << std::endl;
  std::cout << int_min_priority_queue << std::endl;
  ...
  std::cout << "Extract Min: " << str_min_priority_queue.ExtractMin() << std::endl;
  std::cout << "Size: " << str_min_priority_queue.GetSize() << std::endl;
  std::cout << str_min_priority_queue << std::endl;
