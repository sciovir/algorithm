...
int main() {
  ...
  data_structures::queues::MaxPriorityQueue<int> int_max_priority_queue(integers);
  data_structures::queues::MaxPriorityQueue<std::string> str_max_priority_queue(strings);
  ...
  std::cout << "Extract Max: " << int_max_priority_queue.ExtractMax() << std::endl;
  std::cout << "Size: " << int_max_priority_queue.GetSize() << std::endl;
  std::cout << int_max_priority_queue << std::endl;
  ...
  std::cout << "Extract Max: " << str_max_priority_queue.ExtractMax() << std::endl;
  std::cout << "Size: " << str_max_priority_queue.GetSize() << std::endl;
  std::cout << str_max_priority_queue << std::endl;
