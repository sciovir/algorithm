...
class TestLinearSearch(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        super(TestLinearSearch, self).__init__(*args, **kwargs)
    ...
    def test_handles_multiple_array_type_input(self):
        ...
        self.assertEqual(linear_search(self.strings, 'c', 0, len(self.strings) - 1), 0)
    ...
    def test_handles_non_exist_element_input(self):
        ...
        self.assertEqual(linear_search(self.strings, 'rust', 0, len(self.strings) - 1), -1)
